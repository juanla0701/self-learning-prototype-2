(function (root) {
  ...
  document.getElementById("categoryPicker").addEventListener("click", (e) => {
    ...
    if (btn) UI.setSelectedCategory(btn.dataset.category);
  });
  ...
  document.getElementById("menuSignalsBtn").addEventListener("click", () => UI.switchView("signals"));
